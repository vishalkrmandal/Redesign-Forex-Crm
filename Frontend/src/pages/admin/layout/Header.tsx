            ...
            <div className="absolute right-0 mt-2 w-64 rounded-md border bg-background shadow-lg">
              <div className="flex items-center gap-3 border-b p-4">
                <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center overflow-hidden rounded-full bg-primary">
                  <svg
                    viewBox="0 0 482.9 482.9"
                    className={`h-8 w-8 ${profileIconColor}`}
                    aria-hidden="true"
                  >
                    <g>
                      <path d="M239.7,260.2c0.5,0,1,0,1.6,0c0.2,0,0.4,0,0.6,0c0.3,0,0.7,0,1,0c29.3-0.5,53-10.8,70.5-30.5
              ...
              <div className="py-1">
                <button className="flex w-full items-center gap-3 px-4 py-2 text-left hover:bg-accent">
                ...
                <button
                  className="flex w-full items-center gap-3 border-t px-4 py-2 text-left hover:bg-accent"
