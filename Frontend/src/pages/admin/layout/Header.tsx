...
const PAGE_TITLES: Record<string, string> = {
  "/admin": "Dashboard",
  "/admin/features/clients": "Clients",
  "/admin/features/deposits": "Deposits",
  "/admin/features/withdrawals": "Withdrawals",
  "/admin/features/transactions": "Transactions",
  "/admin/configure": "Configure",
  "/admin/partner/ib-partners": "IB Partners",
  "/admin/partner/ib-withdrawals": "IB Withdrawals",
}
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        {!isMobile && (
          <div className="hidden md:flex items-center gap-2">
            <span className="text-xs" style={{ color: "var(--theme-text-disabled)" }}>Admin</span>
      ...
      <div ref={searchContainerRef} className="relative flex-1 max-w-sm mx-4 hidden md:block">
        {showSearch ? (
          ...
          >
            ...
            <kbd className="ml-auto rounded px-1.5 py-0.5 text-xs font-mono" style={{ border: "1px solid var(--theme-border)", color: "var(--theme-text-disabled)" }}>⌘K</kbd>
          </button>
        )}
        ...
        {showSearch && searchResults.length > 0 && (
          ...
          >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1 text-left">
                      <p className="text-sm font-medium truncate" style={{ color: isSelected ? "var(--theme-primary)" : "var(--theme-text-primary)" }}>
                        {page.label}
                      </p>
                    </div>
                    <span
            ...
            <div className="px-4 py-1.5 flex items-center gap-2" style={{ borderTop: "1px solid var(--theme-border)" }}>
      ...
      <div className="flex items-center gap-2">
        <button onClick={() => setShowSearch(true)} className="md:hidden rounded-lg p-2" style={{ color: "var(--theme-text-muted)" }}>
            ...
            {!isMobile && (
              <>
                <div className="hidden md:block text-left">
                  ...
                  <p className="text-[10px]" style={{ color: "var(--theme-text-disabled)" }}>Admin</p>
                </div>
                <ChevronDown className={`h-3.5 w-3.5 transition-transform duration-200 ${showUserMenu ? "rotate-180" : ""}`} style={{ color: "var(--theme-text-muted)" }} />
              </>
            )}
          </button>
          ...
          {showUserMenu && (
            ...
            >
              <div className="flex items-center gap-3 p-4" style={{ borderBottom: "1px solid var(--theme-border)" }}>
                <div className="flex h-12 w-12 items-center justify-center rounded-full text-sm font-bold text-white shadow-lg flex-shrink-0" style={{ background: "linear-gradient(135deg, var(--theme-primary), var(--theme-primary-hover))" }}>
                  {getInitials()}
                </div>
                <div className="min-w-0">
                  ...
                  {activeRole && (
                    <div className="mt-1 flex items-center gap-1">
                      ...
                      <span className="text-xs font-medium capitalize" style={{ color: "var(--theme-primary)" }}>{activeRole}</span>
                    </div>
                  )}
                </div>
              </div>
      ...
      {showSearch && isMobile && (
        <div className="fixed inset-0 z-50 flex flex-col items-start pt-4 px-4 backdrop-blur-sm" style={{ backgroundColor: "color-mix(in srgb, var(--theme-bg-main) 80%, transparent)" }}>
          <div className="flex w-full gap-3">
            ...
            <button onClick={() => { setShowSearch(false); setSearchQuery(""); setSelectedIndex(-1) }} className="rounded-lg p-2" style={{ color: "var(--theme-text-muted)" }}>
              <X className="h-5 w-5" />
            </button>
          </div>
  ...
  return (
    <button
      ...
      style={{
        ...
        backgroundColor: hovered ? (danger ? "color-mix(in srgb, var(--theme-danger) 10%, transparent)" : "color-mix(in srgb, var(--theme-primary) 8%, transparent)") : "transparent",
      }}
    >
