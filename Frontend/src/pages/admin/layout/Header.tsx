//Frontend\src\pages\admin\layout\Header.tsx

import { useTheme } from "@/context/ThemeContext"
import { Menu, Moon, Sun, Bell, User, Calendar } from "lucide-react"
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="relative">
          <button
            ...
            className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-full border bg-purple-700 text-white hover:opacity-90"
          ...
          {showUserMenu && (
            <div className="absolute right-0 mt-2 w-64 rounded-md border bg-background shadow-lg">
              <div className="flex items-center gap-3 border-b p-4">
                <div className="h-12 w-12 flex-shrink-0 overflow-hidden rounded-full bg-purple-700">
                  <img src="/api/placeholder/48/48" alt="User" className="h-full w-full object-cover" />
                </div>
                <div className="flex-1">
                  <h3 className="font-semibold">Kevin Larry</h3>
                  <p className="text-sm text-muted-foreground">warren@example.com</p>
                </div>
              </div>

              <div className="py-1">
                <button className="flex w-full items-center gap-3 px-4 py-2 text-left hover:bg-gray-100">
                ...
                <button
                  className="flex w-full items-center gap-3 border-t px-4 py-2 text-left hover:bg-gray-100"
